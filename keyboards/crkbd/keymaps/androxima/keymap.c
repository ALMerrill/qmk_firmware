...
enum layer_names { _QWERTY, _LOWER, _RAISE, _ADJUST, _LOL, _LOL_F, _LOL_TYPE, _LOL_TYPE_2 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOL] = LAYOUT(
		...
		KC_NO, KC_A, KC_S, KC_D, KC_F, KC_G, 					KC_B, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
									LOL_F, CCTL, VALT, 	KC_NO, KC_NO, KC_NO
	),
	[_LOL_F] = LAYOUT(
	...
	[_LOL_TYPE] = LAYOUT(
		...
		_LSFT, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	SFTENT, 
									GUIC, 	KC_NO, SFTENT, 	KC_SPC, _TYPE_2, 	KC_RALT
	),
	[_LOL_TYPE_2] = LAYOUT(
