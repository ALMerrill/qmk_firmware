...
enum layer_names { _QWERTY, _LOWER, _RAISE, _ADJUST, _LOL, _LOL_2 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		LSFT, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	SFTENT, 
	...
	[_LOWER] = LAYOUT(
		...
		LSFT, 	KC_0, 	KC_1, 	KC_2, 	KC_3, 	KC_L, 			KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 
	...
	[_RAISE] = LAYOUT(
		...
		KC_LSFT, KC_F6, KC_7, KC_8, KC_9, KC_F10, 				KC_NO, KC_MINS, KC_UNDS, KC_LBRC, KC_RBRC, KC_NO, 
