...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		_LSFT, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	SFTENT, 
									GUIC, 	LOENT, KC_LSFT, KC_BSPC,  RASPC,  KC_RALT
	),
	[_DVORAK] = LAYOUT(
	...
	[_LOWER] = LAYOUT(
		...
		_LSFT, 	KC_0, 	KC_1, 	KC_2, 	KC_3, 	KC_L, 			KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 
									KC_LGUI,KC_TRNS,  KC_LSFT, KC_BSPC, ADJUST, KC_RALT
	),
	[_RAISE] = LAYOUT(
		KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, 		KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, 
		KC_LCTL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, 			KC_UNDS, KC_PLUS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, 
		_LSFT, KC_F6, KC_7, KC_8, KC_9, KC_F10, 				KC_NO, KC_MINS, KC_UNDS, KC_LBRC, KC_RBRC, SFTENT, 
									KC_LGUI, ADJUST, KC_LSFT, KC_BSPC, KC_TRNS, KC_RALT
	),
	[_ADJUST] = LAYOUT(
		...
		RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO, KC_L, 		KC_WBAK, KC_WFWD, KC_BRID, KC_BRIU, KC_NO, DVORAK, 
									KC_LGUI, KC_TRNS,KC_LSFT, KC_BSPC, KC_TRNS, KC_RALT
	),
	[_LOL] = LAYOUT(
