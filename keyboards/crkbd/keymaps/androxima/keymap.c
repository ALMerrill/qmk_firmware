...
enum layer_names { _QWERTY, _DVORAK, _LOWER, _RAISE, _ADJUST, _LOL, _LOL_F, _LOL_TYPE, _LOL_TYPE_2 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_DVORAK] = LAYOUT(
		KC_TAB, COMM,	KC_DOT, KC_SLSH,KC_P, 	KC_Y, 			KC_F, 	KC_G, 	KC_C, 	KC_R, 	KC_L, 		KC_BSPC, 
		ESCC, 	KC_A, 	KC_O, 	KC_E, 	KC_U, 	KC_I, 			KC_D, 	KC_H, 	KC_T, 	KC_N, 	KC_S, 		KC_QUOT, 
	...
	[_ADJUST] = LAYOUT(
		...
		RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, KC_L, KC_NO,	 	KC_WSCH, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, QWERTY, 
		RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_NO, KC_L, 		KC_WBAK, KC_WFWD, KC_BRID, KC_BRIU, KC_NO, DVORAK, 
