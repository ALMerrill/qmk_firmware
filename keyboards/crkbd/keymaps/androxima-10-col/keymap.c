...
enum layer_names { _QWERTY, _LOWER, _RAISE, _ADJUST, _LOL, _LOL_F, _LOL_TYPE };

#define QWERTY TO(_QWERTY)
#define LOWER MO(_LOWER)
#define LOWGUI LGUI_T(_LOWER)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		_LSFT, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	SFTENT, 
									GUIC, 	LOWER, SFTENT, 	KC_SPC, RAISE, 	KC_RALT
	),
	[_LOWER] = LAYOUT(
		KC_GRV, KC_NO, 	KC_7, 	KC_8, 	KC_9, 	KC_NO, 			KC_HOME, 	KC_PGDN, 	KC_PGUP, 	KC_END, 	KC_PSCR, 	KC_DEL, 
		ESCC,	KC_NO, 	KC_4, 	KC_5, 	KC_6, 	KC_NO, 			KC_LEFT, 	KC_DOWN, 	KC_UP, 		KC_RGHT, 	KC_INS, 	KC_BSLS, 
		_LSFT, 	KC_0, 	KC_1, 	KC_2, 	KC_3, 	KC_L, 			KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 
									KC_LGUI,KC_TRNS,SFTENT, KC_SPC, ADJUST, KC_RALT
	),
	[_RAISE] = LAYOUT(
		KC_TILD, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, 		KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, 
		ESCC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, 			KC_UNDS, KC_PLUS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, 
		_LSFT, KC_F6, KC_7, KC_8, KC_9, KC_F10, 				KC_NO, KC_MINS, KC_UNDS, KC_LBRC, KC_RBRC, KC_NO, 
									KC_LGUI, ADJUST, SFTENT, KC_SPC, KC_TRNS, KC_RALT
	),
	[_ADJUST] = LAYOUT(
		RESET, KC_NO, KC_NO, KC_NO, KC_NO, 	EEP_RST, 				KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, LOL, 
	...
	[_LOL] = LAYOUT(
		...
		KC_NO, KC_A, KC_S, KC_D, KC_F, KC_G, 					KC_B, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
									LOL_F, CCTL, VALT, KC_B, KC_NO, KC_NO
	),
	[_LOL_F] = LAYOUT(
