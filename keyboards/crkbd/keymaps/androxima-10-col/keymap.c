...
enum layer_names { _QWERTY, _HOME, _DVORAK, _LOWER, _RAISE, _ADJUST, _NUMBER, _LOL, _LOL_F};

#define QWERTY TO(_QWERTY)
#define HOME TO(_HOME)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		_LSFT, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	SFTENT, 
								   SFT_TAB,  LOWENT, KC_LGUI, BSPC_A,  RASPC,  NUMESC
	),
	[_HOME] = LAYOUT(
		...
		KC_NO, 	KC_Z, 	KC_X, 	KC_C, 	KC_V, 	KC_B, 			KC_N, 	KC_M, 	COMM, 	KC_DOT, KC_SLSH, 	KC_NO,
									SFT_TAB,  LOWENT, KC_LGUI, KC_BSPC,  RASPC,  NUMESC
	),
	[_DVORAK] = LAYOUT(
	...
	[_LOWER] = LAYOUT(
		...
		KC_NO, KC_NO, KC_4, 	KC_5, 	KC_6, 	KC_ENT, 			KC_BSPC,    KC_PLUS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, 
		KC_NO, 	 KC_0, 	KC_1, 	KC_2, 	KC_3, 	KC_NO, 			KC_NO,      KC_MINS, KC_UNDS, KC_LBRC, KC_RBRC, SFTENT, 
									KC_LGUI, KC_TRNS, KC_LSFT, KC_DEL, ADJSPC, NUMBER
	),
	[_RAISE] = LAYOUT(
		...
		_LSFT, 	 KC_NO,   KC_NO, 	KC_NO, 	KC_NO, 	KC_L, 			KC_HOME, 	KC_PGDN, 	KC_PGUP, 	KC_END, 	KC_NO, 		KC_NO, 
									KC_LGUI,LOWER,  KC_LALT,   KC_NO, KC_TRNS, NUMBER
	),
	[_ADJUST] = LAYOUT(
		RESET, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 		            KC_NO, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, LOL, 
		KC_NO, KC_NO, KC_NO, KC_NO, HOME, KC_NO,	 	            KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO, QWERTY, 
