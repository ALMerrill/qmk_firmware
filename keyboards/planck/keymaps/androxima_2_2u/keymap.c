...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_planck_2x2u(
            ...
            KC_NO, KC_LCTL, KC_LALT, KC_LGUI, LOSPC     ,       RASPC, NUMLEFT, KC_DOWN, KC_UP, KC_RGHT
    ),
    [_DVORAK] = LAYOUT_planck_2x2u(
            ...
            KC_NO, KC_LCTL, KC_LALT, KC_LGUI, LOWER, RASPC, NUMLEFT, KC_DOWN, KC_UP, KC_RIGHT
    ),
    [_LOWER]  = LAYOUT_planck_2x2u(
            KC_TILD, KC_NO, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_NO, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, 
            ...
            KC_NO, KC_NO, KC_NO, KC_LGUI, KC_TRNS, ADJSPC, NUMBER, KC_NO, KC_NO, KC_NO
    ),
    [_RAISE]  = LAYOUT_planck_2x2u(
            ...
            KC_NO, KC_NO, KC_NO, KC_LGUI, LOWER, KC_TRNS, NUMBER, KC_NO, KC_NO, KC_NO
    ),
    [_ADJUST] = LAYOUT_planck_2x2u(
            ...
            KC_NO, KC_NO, KC_NO, KC_LGUI, KC_TRNS, KC_TRNS, NUMBER, KC_NO, KC_NO, KC_NO
    ),
    [_NUMBER] = LAYOUT_planck_2x2u(
            ...
            KC_NO, KC_NO, KC_NO, GUIC, LOWER, RASPC, KC_TRNS, KC_NO, KC_NO, KC_NO
    ),
    [_LOL]    = LAYOUT_planck_2x2u(
            ...
            _LSFT, KC_NO, VALT, KC_LCTL, LOL_F, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),
    [_LOL_F]  = LAYOUT_planck_2x2u(
